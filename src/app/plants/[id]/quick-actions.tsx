...
import { ClipboardCheck, Droplets, Sprout, Trash2 } from "lucide-react";
...
export function QuickActions({ plantId, onCheckIn }: QuickActionsProps) {
  ...
  return (
    <>
      <div className="flex gap-2">
        {onCheckIn && (
          <Button variant="outline" size="sm" className="flex-1" onClick={onCheckIn}>
            <ClipboardCheck className="mr-1 h-4 w-4 text-purple-500" />
            Check-in
          </Button>
        )}
